...
namespace Taxii.Controllers
{
    ...
    public class CollectionsController : ControllerBase
    {
        ...
        public string Get()
        {
            var res = "{\"collections\": [{\"can_read\": true,\"can_write\": false,\"description\": \"\",\"id\": \"107\",\"title\": \"Phish Tank\"},{\"can_read\": true,\"can_write\": false,\"description\": \"\",\"id\": \"67394485-b4dc-4628-b3a2-079000fee115\",\"title\": \"Abuse.ch Ransomware IPs\"}]}";
        ...
        public string GetCollection([FromRoute] string id)
        {
            switch (id) {
                case "107":
                    return "{\"can_read\": true, \"can_write\": false, \"description\": \"\", \"id\": \"107\", \"title\": \"Phish Tank\"}";
